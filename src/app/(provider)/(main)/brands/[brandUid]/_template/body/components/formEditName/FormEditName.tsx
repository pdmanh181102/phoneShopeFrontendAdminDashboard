...
const FormEditName: React.FC<FormProps> = ({ visible, uid, onCancel, onSuccess }) => {
  ...
  const createItemMutation = useMutation({
    ...
    onError: (error: any) => {
      getMessageApi().error(error?.message || "Có lỗi xảy ra khi sửa tên thương hiệu");
    },
  });
  ...
  return (
    <Modal title="Sửa tên thương hiệu" open={visible} onCancel={handleCancel} footer={null} width={500} destroyOnHidden>
